...
SUBMODULOS_COMPRAS = [
    ...
    {"codigo": "orden_sugerida", "label": "Orden Sugerida", "icon": "fa5s.magic"},
    {"codigo": "recepcion", "label": "Recepcion", "icon": "fa5s.dolly"},
    {"codigo": "historial_compras", "label": "Historial", "icon": "fa5s.history"},
]
...
class ComprasView(QWidget):
    ...
    def _create_submodule(self, codigo: str) -> QWidget:
        ...
        if codigo == "orden_sugerida":
            from modulos.compras.views.orden_sugerida_view import OrdenSugeridaView
            return OrdenSugeridaView()
        page = QWidget()
