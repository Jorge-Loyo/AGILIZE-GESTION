...
class RRHHView(QWidget):
    ...
    def _create_submodule(self, codigo: str) -> QWidget:
        if codigo == "dashboard":
            from modulos.empleados.views.dashboard_rrhh_view import DashboardRRHHView
        ...
        if codigo == "asistencia":
            from modulos.empleados.views.asistencia_view import AsistenciaView
            return AsistenciaView()
        if codigo == "cierres":
            from modulos.empleados.views.cierres_view import CierresAsistenciaView
            return CierresAsistenciaView()
        if codigo == "nomina":
            from modulos.nomina.views.nomina_view import NominaView
            return NominaView()
        if codigo == "config":
            from modulos.empleados.views.config_rrhh_view import ConfigRRHHView
