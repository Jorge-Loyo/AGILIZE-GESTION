...
SUBMODULOS_CUENTAS = [
    {"codigo": "cta_clientes", "label": "Clientes", "icon": "fa5s.user-tie"},
    {"codigo": "cta_proveedores", "label": "Proveedores", "icon": "fa5s.truck"},
]


class CuentasView(QWidget):
    ...
    def _build_ui(self):
        ...
        for i, sub in enumerate(SUBMODULOS_CUENTAS):
    ...
    def _create_submodule(self, codigo: str) -> QWidget:
        if codigo == "cta_clientes":
            from modulos.cuentas.views.cta_corriente_view import CtaCorrienteView
            return CtaCorrienteView("cliente")
        if codigo == "cta_proveedores":
            from modulos.cuentas.views.cta_corriente_view import CtaCorrienteView
            return CtaCorrienteView("proveedor")
        return QWidget()
